...
config_path = dir_path / "configs" / "segformer.yaml"
...
class SegFormer(nn.Module):
    def __init__(self, in_channels, num_classes, use_pretrained = True, use_hadamard: bool = False, *args, **kwargs):
        ...
        self.model = Segformer(encoder_name=ENCODER_NAME, 
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        model = SegFormer(in_channels=3, num_classes=19, use_pretrained=False, use_hadamard=True)
        output = model(x) 
